...
#initializing the client MQTT3.1.1
client = mqtt.Client(client_id='receiver',protocol=4,clean_session=0)  
...
client.tls_set(certfile='.\\ssl\\cert.cer',keyfile='.\\ssl\\key.key')
